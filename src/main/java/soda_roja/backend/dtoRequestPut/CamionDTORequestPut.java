...
public class CamionDTORequestPut {
	...
	@Size(min=3, max = 250, message = "El modelo no puede tener menos de 3 caracteres ni más de 250 caracteres") // Valida el tamaño del campo
	@Schema(example = "Sprinter Chasis", description = "Modelo del camion")
    private String modelo;
	
	@Size(min=3, max = 250, message = "La marca no puede tener menos de 3 caracteres ni más de 250 caracteres") // Valida el tamaño del campo
